        ...
        while True:
            ...
            if message:
                ...
                cipher = AES.new(key, AES.MODE_CFB,
                                 iv=iv)  # Create and AES object, parameters: [secret_key], [counter feedback mode], [initialization vector]
                msg = cipher.decrypt(cipherText)  # Use the object to decrypt the ciphertext
                current_time = datetime.datetime.now()
                print(colored(current_time.strftime('%Y-%m-%d %H:%M:%S ') + msg.decode(),
                              'green'))  # It produces a byte encoded output so you have to decode it to display as string
            else:
