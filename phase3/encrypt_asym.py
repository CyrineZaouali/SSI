...
menu = {
    "5-1": {"message": "Encrypt Message RSA", "func": encrypt_rsa_cli},
    "5-2": {"message": "Decrypt Message RSA", "func": decrypt_rsa_cli},
    "5-3": {"message": "Encrypt Message Elgamal", "func": encrypt_elgamal_cli},
    "5-4": {"message": "Decrypt Message Elgamal", "func": decrypt_Elgamal_cli},
}
